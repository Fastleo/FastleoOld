...
Route::middleware(['web', Camanru\Fastleo\CheckAuth::class])->group(function () {
    ...
    Route::get('/fastleo/app/{model}/menu_on', 'Camanru\Fastleo\ModelController@menuOn');
    Route::get('/fastleo/app/{model}/menu_off', 'Camanru\Fastleo\ModelController@menuOff');
    Route::get('/fastleo/app/{model}/menu_add', 'Camanru\Fastleo\ModelController@menuAdd');
